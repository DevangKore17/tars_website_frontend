...
export function VisionMission() {
  return (
    <section id="vision" className="relative z-10 pt-20 pb-32">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 flex flex-col lg:flex-row gap-12 lg:gap-24 relative">
        ...
        <div className="lg:w-1/3 relative z-20">
          <div className="sticky top-32 md:top-40">
            ...
            <p className="text-gray-400 font-body text-lg md:text-xl leading-relaxed tracking-wide">
              The fundamental protocols and objectives driving the Technical Automation and Robotics Society.
            </p>
            
            {/* Visual connecting line going down */}
            <div className="hidden lg:block absolute left-2 top-40 w-[1px] h-[50vh] bg-gradient-to-b from-tars-green via-[#333] to-transparent opacity-50"></div>
          </div>
        </div>

        {/* Scrolling Right Side */}
        <div className="lg:w-2/3 space-y-16 md:space-y-32 relative z-10">
          ...
          <Tilt tiltMaxAngleX={4} tiltMaxAngleY={4} scale={1.02} transitionSpeed={2000}>
            <div className="relative border border-[#333333] p-8 md:p-12 lg:p-16 group hover:border-tars-green/50 active:border-tars-green/50 transition-colors duration-500 bg-[#0A0A0A]/80 backdrop-blur-sm overflow-hidden rounded-xl shadow-[0_0_20px_rgba(0,0,0,0.5)]">
              ...
              <div className="flex items-center mb-6 lg:mb-8 border-b border-[#333] pb-4">
              ...
              <div className="mt-6 lg:mt-8 text-gray-300 text-lg md:text-xl lg:text-2xl font-body leading-relaxed relative z-10">
          ...
          <Tilt tiltMaxAngleX={4} tiltMaxAngleY={4} scale={1.02} transitionSpeed={2000}>
            <div className="relative border border-[#333333] p-8 md:p-12 lg:p-16 group hover:border-tars-green/50 active:border-tars-green/50 transition-colors duration-500 bg-[#0A0A0A]/80 backdrop-blur-sm overflow-hidden rounded-xl shadow-[0_0_20px_rgba(0,0,0,0.5)]">
              ...
              {/* Nodes */}
              <div className="absolute top-4 right-4 w-2 h-2 rounded-full bg-[#333] group-hover:bg-tars-green group-active:bg-tars-green group-hover:shadow-[0_0_8px_rgba(0,255,65,0.8)] group-active:shadow-[0_0_8px_rgba(0,255,65,0.8)] transition-all duration-300"></div>
              <div className="absolute bottom-4 left-4 w-2 h-2 rounded-full bg-[#333] group-hover:bg-tars-green group-active:bg-tars-green group-hover:shadow-[0_0_8px_rgba(0,255,65,0.8)] group-active:shadow-[0_0_8px_rgba(0,255,65,0.8)] transition-all duration-300"></div>
